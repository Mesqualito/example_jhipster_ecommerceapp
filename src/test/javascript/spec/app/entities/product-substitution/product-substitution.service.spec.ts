...
describe('Service Tests', () => {
  describe('ProductSubstitution Service', () => {
    let injector: TestBed;
    let service: ProductSubstitutionService;
    let httpMock: HttpTestingController;
    let elemDefault: IProductSubstitution;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ProductSubstitutionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new ProductSubstitution(0, 'AAAAAAA', false, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProductSubstitution', async () => {
        ...
        service
          .create(new ProductSubstitution(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should delete a ProductSubstitution', async () => {
