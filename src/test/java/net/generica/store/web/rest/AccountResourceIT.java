...
import net.generica.store.config.Constants;
import net.generica.store.domain.Authority;
import net.generica.store.domain.User;
import net.generica.store.repository.AuthorityRepository;
import net.generica.store.repository.UserRepository;
import net.generica.store.security.AuthoritiesConstants;
import net.generica.store.service.MailService;
import net.generica.store.service.UserService;
import net.generica.store.service.dto.PasswordChangeDTO;
import net.generica.store.service.dto.UserDTO;
import net.generica.store.web.rest.errors.ExceptionTranslator;
import net.generica.store.web.rest.vm.KeyAndPasswordVM;
import net.generica.store.web.rest.vm.ManagedUserVM;
