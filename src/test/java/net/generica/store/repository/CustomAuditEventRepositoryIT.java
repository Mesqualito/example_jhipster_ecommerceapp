...
import net.generica.store.config.audit.AuditEventConverter;
import net.generica.store.domain.PersistentAuditEvent;
...
import static net.generica.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
