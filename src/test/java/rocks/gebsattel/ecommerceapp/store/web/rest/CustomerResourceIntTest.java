...
import rocks.gebsattel.ecommerceapp.store.domain.enumeration.Gender;
/**
...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = ")w@JZ.WQ";
    private static final String UPDATED_EMAIL = "%o@m2.?";
