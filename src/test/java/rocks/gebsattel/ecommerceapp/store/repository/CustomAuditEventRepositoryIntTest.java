...
import rocks.gebsattel.ecommerceapp.store.config.audit.AuditEventConverter;
import rocks.gebsattel.ecommerceapp.store.domain.PersistentAuditEvent;
...
import static rocks.gebsattel.ecommerceapp.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
