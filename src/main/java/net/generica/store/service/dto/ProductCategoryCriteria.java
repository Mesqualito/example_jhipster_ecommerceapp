...
/**
 * Criteria class for the {@link net.generica.store.domain.ProductCategory} entity. This class is used
 * in {@link net.generica.store.web.rest.ProductCategoryResource} to receive all the possible filtering options from
