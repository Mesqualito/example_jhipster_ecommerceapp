...
/**
 * Criteria class for the {@link net.generica.store.domain.Shipment} entity. This class is used
 * in {@link net.generica.store.web.rest.ShipmentResource} to receive all the possible filtering options from
