...
/**
 * Criteria class for the {@link net.generica.store.domain.OrderItem} entity. This class is used
 * in {@link net.generica.store.web.rest.OrderItemResource} to receive all the possible filtering options from
