...
/**
 * Criteria class for the {@link net.generica.store.domain.ProductOrder} entity. This class is used
 * in {@link net.generica.store.web.rest.ProductOrderResource} to receive all the possible filtering options from
