package rocks.gebsattel.ecommerceapp.store;

import rocks.gebsattel.ecommerceapp.store.config.ApplicationProperties;
import rocks.gebsattel.ecommerceapp.store.config.DefaultProfileUtil;
