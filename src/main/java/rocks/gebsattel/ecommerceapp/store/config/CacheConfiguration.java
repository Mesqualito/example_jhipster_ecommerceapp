package rocks.gebsattel.ecommerceapp.store.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("rocks.gebsattel.ecommerceapp.store.domain.*", initializeDomainMapConfig(jHipsterProperties));
